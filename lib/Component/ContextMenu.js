...
var ContextMenu = function (_Component) {
  ...
  _createClass(ContextMenu, [{
    ...
    value: function getMenuItem() {
      return _react2.default.Children.map(_react2.default.Children.toArray(this.props.children).filter(_react.isValidElement), _react2.default.cloneElement);
    }
  }, {
    key: 'getMenuStyle',
